...
fun AdvancedOptions(
    ...
    Row(modifier = Modifier
        ...
        Text(
            R.string.advanced_options.stringRes,
    ...
    ExpandedAnimatedVisibility(showAdvanced.value) {
        Column {
            CompoundDropdownMenu(
                ...
                label = R.string.protocol.stringRes,
                modifier = Modifier
                    .padding(bottom = 4.dp)
                    .fillMaxWidth(),
            ...
            CompoundDropdownMenu(
                ...
                label = R.string.heartbeat_strategy.stringRes,
                modifier = Modifier
                ...
                Column {
                    ExpandedAnimatedVisibility(heartbeatStrategy.value == AccountsOuterClass.Accounts.heartbeat_strategy.REGISTER) {
                        NumberOutlinedTextField(
                            ...
                            label = R.string.heartbeat_period_millis.stringRes,
                            enabled = state.value is LoginState.Default
                        ) {
                    ...
                    ExpandedAnimatedVisibility(heartbeatStrategy.value == AccountsOuterClass.Accounts.heartbeat_strategy.STAT_HB) {
                        NumberOutlinedTextField(
                            ...
                            label = R.string.stat_heartbeat_timeout_millis.stringRes,
                            enabled = state.value is LoginState.Default
                        ) {
                    ...
                    NumberOutlinedTextField(
                        ...
                        label = R.string.heartbeat_timeout_millis.stringRes,
                        enabled = state.value is LoginState.Default
                    ) {
            ...
            Row(
                ...
                Text(
                    text = R.string.auto_reconnect.stringRes,
            ...
            ExpandedAnimatedVisibility(autoReconnect.value) {
                NumberOutlinedTextField(
                    ...
                    label = R.string.reconnection_retry_times.stringRes,
                    modifier = Modifier
                        .padding(top = 4.dp)
                        .fillMaxWidth(),
                    enabled = state.value is LoginState.Default
