...
value class Either<out L : Any, out R : Any?> private constructor(
    ...
    public companion object {
        ...
        public inline val <L : Any, reified R> Either<L, R>.rightOrNull: R? get() = value as? R
        public inline val <L : Any, reified R> Either<L, R>.right: R get() = value as R

        public inline val <reified L : Any, R> Either<L, R>.leftOrNull: L? get() = value as? L
        public inline val <reified L : Any, R> Either<L, R>.left: L get() = value as L
